...
def main():
    image = Image.open("..\PL.jpg") #enter the location of the image after download from repository
    ...
    if ft_selection == 'Player Stat Comparison':
        ...
        def load_data():
            data = pd.read_excel("..\PL.xlsx",sheet_name = stat) #enter the location of the dataset after download from repository
            return data
    ...
    if ft_selection == 'Top Performers':
        ...
        def load_data():
            data = pd.read_excel("..\PL.xlsx",sheet_name = "Miscellaneous") #enter the location of the dataset after download from repository
            return data
